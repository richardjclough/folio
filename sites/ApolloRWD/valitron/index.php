...
if (isset($_POST['advertisersSubmit']) && !empty($_POST['advertisersSubmit']))
    ...
    if (isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
        ...
        $secret = '6LfB6g0TAAAAAAzxAJeEG23bsPVTCciiGCasZsvi';
            ...
            <div class="content">
                <section class="content-section" id="aboutus">
                    <div class="section-inner" id="aboutus-anchor">
                     ...
                     <section class="content-section" id="portfolio">
                        <header class="heading">  
                            <em class="subtitle">A varied range of websites to accommodate all needs and offer intuitive navigation to users</em>    
                        </header>
                         ...
                         <div class="twoColumns">
                            <div class="leftColumn">
                                        ...
                                        <h3>Advertiser Login</h3>
                                         <a href="https://login.apollomedia.com.au/advertisers" class="submit">ADVERTISERS LOGIN</a>                   
                                        </div>               
                    ...
                    <section class="content-section" id="contact">
                        <header class="heading"> 
                                <em class="subtitle">Business continuity that withstands<br /> environmental norms
                                </em>   
                        </header> 
                        <h4>&nbsp;</h4>
                 ...
                 <div class="contact-inner" id="contact-anchor" >
                            <div class="contactContent">
                                ...
                                <p>
                                    ...
                                    Email <a href="mailto:contact@apollomedia.com.au">contact@apollomedia.com.au</a><br />
                            ...
                            <div class="map">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3046.101106537485!2d144.94342896639034!3d-37.82048104395435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d59422626e1%3A0xb54ce0869eb6d64c!2s838+Collins+St%2C+Docklands+VIC+3008!5e0!3m2!1sen!2sau!4v1443157549735" width="480" height="480" style="border:0" allowfullscreen></iframe>
                                <br />
